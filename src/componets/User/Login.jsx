...
const Login = () => {
  return (
    <div class="relative transition-all duration-500 ease-in-out flex w-70 md:w-96 flex-col mt-10 rounded-xl bg-white bg-clip-border text-gray-700 shadow-md md:mb-8">
