    ...
    <div
      className={`${
        navbg
          ...
          : "bg-transparent"
      } h-[10ch] z-[10] w-full flex items-center transition-all duration-200`}
    >
      <div className="flex  items-center h-full justify-between w-[100%] sm:w-[100%] xl:w-[100%] mx-auto md:px-2 sm:px-0  px-2   bg-black py-2  border border-transparent text-center shadow-md focus:bg-slate-700 focus:shadow-none active:bg-slate-70">
        {/* LOGO */}
